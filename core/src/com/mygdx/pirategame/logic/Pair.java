...
/**
 * Created by tom Used as a return type when returning a pair of objects
 *
 * @param <A>
 * @param <B>
 */
public class Pair<A, B> {
  ...
  public boolean equals(Object other) {
    if (other instanceof Pair) {
      ...
      return ((this.fst == otherPair.fst
              || (this.fst != null && otherPair.fst != null && this.fst.equals(otherPair.fst)))
          && (this.snd == otherPair.snd
              || (this.snd != null && otherPair.snd != null && this.snd.equals(otherPair.snd))));
    }
