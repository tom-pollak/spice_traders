...
/**
 * Available Spawn Class to determine invalid spawn areas Instantiates invalid spawn map
 *
...
public class AvailableSpawn {
  ...
  /** Initialises the Available Spawn Map Generates the validity data for a given area */
  ...
  /**
   * Checks if given value pair is already contained in the map If not contained in the map, adds
   * the data pair to the map
   *
