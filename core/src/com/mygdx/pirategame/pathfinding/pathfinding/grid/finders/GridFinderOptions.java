...
import com.mygdx.pirategame.pathfinding.pathfinding.grid.heuristics.ManhattanDistance;
...
public class GridFinderOptions extends PathFinderOptions {
   ...
   *
   * <p><b>Note:</b> This will be ignored in {@link JumpPointFinder}, as diagonal movement is
   * required for it
   *
   * <p>
   *
  ...
  /**
   * When true, diagonal movement requires both neighbors to be open. When false, diagonal movement
   * can be achieved by having only one open nighbor
   *
   * <p>
   *
   * <p>Example: To go from (1,1) to (2,2) when this is set to true, where (x) denotes a non
   * walkable cell, the following applies
   *
   * <pre>
   *                 Valid           Invalid
   *             +---+---+---+    +---+---+---+
   ...
   * </pre>
   *
   * <p>If {@link #allowDiagonal} is false, this setting is ignored.
   *
   * <p>Default value is true
   */
  ...
  /**
   * When false, (0,0) is located at the bottom left of the grid. When true, (0,0) is located at the
