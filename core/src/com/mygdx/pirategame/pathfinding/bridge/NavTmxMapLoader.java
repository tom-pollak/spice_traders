package com.mygdx.pirategame.pathfinding.bridge;
...
public class NavTmxMapLoader extends TmxMapLoader {
  ...
  public NavTmxMapLoader(
      String navigationLayerName, String navigationProperty, String navigationClosedValue) {
    this(
        new InternalFileHandleResolver(),
        navigationLayerName,
        navigationProperty,
        navigationClosedValue);
  }

  public NavTmxMapLoader(
      FileHandleResolver handler,
      String navigationLayerName,
    ...
    for (int y = 0; y < height; y++) {
      for (int x = 0; x < width; x++) {
        ...
        if (tile != null) {
          ...
          String walkableProp =
              tileProp.get(navigationProperty, navigationClosedValue, String.class);
