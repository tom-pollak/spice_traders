...
public class ShopScreen implements Screen {
    ...
    public void show() {
        ...
        Label stats = new Label("Stats: Acceleration" + player.getAccel() + " Damage: " + player.getDamage(), new Label.LabelStyle(new BitmapFont(), Color.WHITE));
        ...
        movement1.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                if (Hud.getCoins() >= 1) {
                    ...
                    stats.setText("Stats: Acceleration" + player.getAccel() + " Damage: " + player.getDamage());
