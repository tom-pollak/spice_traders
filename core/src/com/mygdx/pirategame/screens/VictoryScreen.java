...
public class VictoryScreen implements Screen {
  ...
  public void show() {
    ...
    Label victoryMsg2 =
        new Label("CONGRATULATIONS PIRATE", new Label.LabelStyle(new BitmapFont(), Color.YELLOW));
  ...
  /**
   * (Not Used since there is no updating features) Update the screen every delta time
   *
   * @param dt Delta Time
   */
