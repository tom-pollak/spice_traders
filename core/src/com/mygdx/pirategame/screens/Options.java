...
public class Options implements Screen {
  ...
  public void show() {
    ...
    volumeMusicSlider.addListener(
        new EventListener() {
          ...
          public boolean handle(Event event) {
            PirateGame.getPreferences()
                .setMusicVolume(
                    volumeMusicSlider.getValue()); // Change music value in options to slider
            PirateGame.song.setVolume(
                PirateGame.getPreferences().getMusicVolume()); // Change the volume
    ...
    volumeEffectSlider.setValue(
        PirateGame.getPreferences().getEffectsVolume()); // Set value to current option
    volumeEffectSlider.addListener(
        new EventListener() {
          @Override
          public boolean handle(Event event) {
            PirateGame.getPreferences()
                .setEffectsVolume(
                    volumeEffectSlider.getValue()); // Change effect value in options to slider
            return false;
          }
        });
