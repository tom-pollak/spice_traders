...
public class Hud implements Disposable {
    ...
    public Hud(SpriteBatch sb) {
        ...
        healthLabel = new Label(String.format("%03d", player.health), new Label.LabelStyle(new BitmapFont(), Color.RED));
    ...
    public static void changeHealth(int value) {
        player.health += value;
        healthLabel.setText(String.format("%02d", player.health));
    }
