...
/**
 * College Fire Defines college attack method Defines college cannonball projectiles
 *
...
public class Projectile extends Entity {
  ...
  /**
   * Defines player position Defines cannonballs
   *
  ...
  public Projectile(
      GameScreen screen, float x, float y, Float velocity, String texturePath, Vector2 target) {
    this(screen, x, y, texturePath, target);
    this.speed = velocity;
  }

  /** Defines cannonball data Defines cannonball shape */
  @Override
