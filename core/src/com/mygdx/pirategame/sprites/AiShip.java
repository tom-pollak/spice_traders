...
public class AiShip extends Ship {
  ...
  /**
   * Moves the ship towards the player if the player is within a certain distance and the ship is in
   * range of their home college
   *
   * @param dt Delta time
   */
    ...
    try {
      ...
      if (target != null) {
        b2body.applyLinearImpulse(
            target, b2body.getWorldCenter(), true); // Player uses linear impulse
      }
