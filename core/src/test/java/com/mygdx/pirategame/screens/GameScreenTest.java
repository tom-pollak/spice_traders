...
class GameScreenTest {
    ...
    void testChangeDamage() {
        ...
        //   test threw
        //   java.lang.NullPointerException: Cannot invoke "com.mygdx.pirategame.sprites.College.changeDamageReceived(int)" because the return value of "com.diffblue.cover.agent.readwrite.RuntimeWrappers.map$get(java.util.Map, Object)" is null
